...
const initialTransactions = [
  ...
  { date: 'Jan 18, 2026', merchant: 'Starbucks', category: 'Dining', amount: 8.75, icon: 'fa-coffee', type: 'expense' },
  { date: 'Jan 17, 2026', merchant: 'Target', category: 'Shopping', amount: 67.99, icon: 'fa-bag-shopping', type: 'expense' },
  { date: 'Jan 17, 2026', merchant: 'Chevron', category: 'Transportation', amount: 52.40, icon: 'fa-gas-pump', type: 'expense' },
  { date: 'Jan 16, 2026', merchant: 'Chipotle', category: 'Dining', amount: 14.25, icon: 'fa-bowl-food', type: 'expense' },
  { date: 'Jan 16, 2026', merchant: 'Amazon', category: 'Shopping', amount: 42.99, icon: 'fa-cart-shopping', type: 'expense' },
  { date: 'Jan 15, 2026', merchant: 'Rent Payment', category: 'Bills and Utilities', amount: 1850.00, icon: 'fa-house', type: 'expense' },
  { date: 'Jan 15, 2026', merchant: 'Paycheck', category: 'Salary', amount: 2500.00, icon: 'fa-money-bill-wave', type: 'income' },
  { date: 'Jan 14, 2026', merchant: 'Whole Foods', category: 'Groceries', amount: 112.34, icon: 'fa-basket-shopping', type: 'expense' },
  { date: 'Jan 14, 2026', merchant: 'Electric Company', category: 'Bills and Utilities', amount: 145.00, icon: 'fa-bolt', type: 'expense' },
  { date: 'Jan 13, 2026', merchant: 'Uber', category: 'Transportation', amount: 18.50, icon: 'fa-car', type: 'expense' },
  { date: 'Jan 13, 2026', merchant: 'Subway', category: 'Dining', amount: 11.25, icon: 'fa-sandwich', type: 'expense' },
  { date: 'Jan 12, 2026', merchant: 'Internet Service', category: 'Bills and Utilities', amount: 79.99, icon: 'fa-wifi', type: 'expense' },
  { date: 'Jan 12, 2026', merchant: 'Phone Bill', category: 'Bills and Utilities', amount: 85.00, icon: 'fa-mobile', type: 'expense' },
  { date: 'Jan 11, 2026', merchant: 'Netflix', category: 'Entertainment', amount: 15.99, icon: 'fa-tv', type: 'expense' },
  { date: 'Jan 11, 2026', merchant: 'Spotify', category: 'Entertainment', amount: 10.99, icon: 'fa-music', type: 'expense' },
  { date: 'Jan 10, 2026', merchant: 'Costco', category: 'Groceries', amount: 198.45, icon: 'fa-warehouse', type: 'expense' },
  { date: 'Jan 10, 2026', merchant: 'Water Utility', category: 'Bills and Utilities', amount: 45.00, icon: 'fa-droplet', type: 'expense' },
  { date: 'Jan 9, 2026', merchant: 'CVS Pharmacy', category: 'Other', amount: 28.50, icon: 'fa-pills', type: 'expense' },
  { date: 'Jan 9, 2026', merchant: 'McDonalds', category: 'Dining', amount: 9.99, icon: 'fa-burger', type: 'expense' },
  { date: 'Jan 8, 2026', merchant: 'Car Insurance', category: 'Bills and Utilities', amount: 125.00, icon: 'fa-car-side', type: 'expense' },
  { date: 'Jan 8, 2026', merchant: 'Gym Membership', category: 'Other', amount: 49.99, icon: 'fa-dumbbell', type: 'expense' },
  { date: 'Jan 7, 2026', merchant: 'Shell Gas', category: 'Transportation', amount: 48.00, icon: 'fa-gas-pump', type: 'expense' },
  { date: 'Jan 7, 2026', merchant: 'Panda Express', category: 'Dining', amount: 12.50, icon: 'fa-bowl-rice', type: 'expense' },
  { date: 'Jan 6, 2026', merchant: 'Safeway', category: 'Groceries', amount: 87.23, icon: 'fa-basket-shopping', type: 'expense' },
  { date: 'Jan 6, 2026', merchant: 'AMC Theater', category: 'Entertainment', amount: 24.00, icon: 'fa-film', type: 'expense' },
  { date: 'Jan 5, 2026', merchant: 'Trash Service', category: 'Bills and Utilities', amount: 35.00, icon: 'fa-trash', type: 'expense' },
  { date: 'Jan 5, 2026', merchant: 'Best Buy', category: 'Shopping', amount: 149.99, icon: 'fa-desktop', type: 'expense' },
  { date: 'Jan 4, 2026', merchant: 'Olive Garden', category: 'Dining', amount: 62.50, icon: 'fa-utensils', type: 'expense' },
  { date: 'Jan 4, 2026', merchant: 'Lyft', category: 'Transportation', amount: 22.00, icon: 'fa-car', type: 'expense' },
  { date: 'Jan 3, 2026', merchant: 'Starbucks', category: 'Dining', amount: 9.25, icon: 'fa-coffee', type: 'expense' },
  { date: 'Jan 3, 2026', merchant: 'Health Insurance', category: 'Bills and Utilities', amount: 320.00, icon: 'fa-heart-pulse', type: 'expense' },
  { date: 'Jan 2, 2026', merchant: 'Whole Foods', category: 'Groceries', amount: 78.50, icon: 'fa-basket-shopping', type: 'expense' },
  { date: 'Jan 2, 2026', merchant: 'Gas & Electric', category: 'Bills and Utilities', amount: 95.00, icon: 'fa-fire-flame-simple', type: 'expense' },
  { date: 'Jan 1, 2026', merchant: 'Monthly Salary', category: 'Salary', amount: 5000.00, icon: 'fa-money-bill-wave', type: 'income' },
  { date: 'Jan 1, 2026', merchant: 'Freelance Project', category: 'Freelance', amount: 750.00, icon: 'fa-laptop-code', type: 'income' },
