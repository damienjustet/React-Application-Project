...
// Shoots logo component
const ShootsLogo = () => (
  <svg className="onboarding-logo" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div className="onboarding-page">
      <div className="onboarding-container">
        ...
        <div className="onboarding-header">
          <ShootsLogo />
          <h1 className="onboarding-brand">Shoots</h1>
        </div>
        ...
        <div className="onboarding-content">
          ...
          <p className="onboarding-subtitle">
            Let's set up your personal finance dashboard.<br />
